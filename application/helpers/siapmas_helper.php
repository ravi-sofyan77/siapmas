<?php
	...
	function get_nama_prasarana($id_prasarana='')
	{
		$ci =&get_instance();
		$ci->load->model('prasarana');
		$data = $ci->prasarana->get($id_prasarana);
		if ($data  && isset($data['nama_prasarana'])) {
			return $data['nama_prasarana'];
		}
		return false;
	}
