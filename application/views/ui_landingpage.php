  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <?php
        	echo anchor('auth/landingpage','Beranda',array('class'=>'nav-link'));
        ?>
      </li>
    </ul>
    <form class="form-inline my-2 my-lg-0">
      ...
      <?php
      	echo anchor('auth/login','Login',array('class'=>'btn btn-outline-primary my-2 my-sm-0'));
      ?>
    </form>
  </div>
</div>
...
<?php echo (isset($alert))? $alert : '' ;?>
	...
	<!--<script type="text/javascript" src="<?php //echo base_url();?>assets/js/sipitt.core.js"></script>-->
