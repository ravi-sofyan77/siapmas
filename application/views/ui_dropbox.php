...
<body>
	<div class="background-admin-1">
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top admin_navbar" style="background-color: #fff!important;">
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav mr-auto">
							<li><?php echo anchor($me.'/index', ucwords('beranda'), array('class' => 'nav-link'))?></li>
							<?php
							if (isset($menu)) {
								$li ='';
						...
						<ul class="navbar-nav ml-auto">
							<li class="nav-item">
								<?php echo anchor($me.'/profile', ucwords('profilku'), array('class'=>'nav-link'))?>
							</li>
							<li class="nav-item">
