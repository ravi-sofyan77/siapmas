...
<ul class="o-list-ui o-list-ui--dividers">
  	<li><?php echo anchor('auth/index', ucwords('beranda'))?></li>
  	<li><?php echo anchor('auth/create_user', ucwords(lang('index_create_user_link')))?></li>
  	<li><?php echo anchor('auth/create_group', ucwords(lang('index_create_group_link')))?></li>
	<li><?php echo anchor('admin/daftar_prasarana', ucwords('prasarana'))?></li>
	<li><?php echo anchor('admin/daftar_sarana', ucwords('sarana'))?></li>
