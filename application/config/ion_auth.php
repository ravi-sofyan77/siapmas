 ...
 */
$config['site_title']                 = "Glite";       // Site Title, example.com
$config['admin_email']                = "iwan.firmawan@jagokomputer.com"; // Admin Email, admin@example.com
$config['default_group']              = 'operator';           // Default group, use name
$config['admin_group']                = 'direksi';             // Default administrators group, use name
